...
export const RecoveryEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Reset your Energy Forward Investor Portal password</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={contentSection}>
          ...
          <Text style={text}>
            ...
            <strong>Energy Forward Investor Portal</strong> account. Click the
            button below to choose a new password. This link will expire shortly
            for your security.
          </Text>
